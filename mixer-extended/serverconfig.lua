...
--[[
Items.setProperty("Heavy", "apxl", Items.Properties.Damage, 960.00)
Items.setProperty("Heavy", "apxl", Items.Properties.DirectHitMultiplier, 1.25)
Items.setProperty("Heavy", "apxl", Items.Properties.ImpactMomentum, 110000.00)
Items.setProperty("Heavy", "apxl", Items.Properties.MinDamageRangeProportion, 1.0)
Items.setProperty("Heavy", "apxl", Items.Properties.MaxDamageRangeProportion, 0.0)
Items.setProperty("Heavy", "apxl", Items.Properties.MinDamageProportion, 0.5)
Items.setProperty("Heavy", "apxl", Items.Properties.ExplosiveRadius, 800.00)
Items.setProperty("Heavy", "apxl", Items.Properties.ExplodeOnContact, true)
